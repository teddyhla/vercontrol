...
- Guidelines, policies etc. typically word documents (proprietary) emailed around.
...
## {background-image="./src/silos.jpg"}
...
-   Practical: time saved, better collaboration, transparency
